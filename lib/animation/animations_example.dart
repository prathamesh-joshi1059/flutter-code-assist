...
class AnimationGrid extends StatefulWidget {
  ...
  const AnimationGrid({Key? key, required this.animationType}) : super(key: key);

  @override
  _AnimationGridState createState() => _AnimationGridState();
}
...
class _AnimationGridState extends State<AnimationGrid> {
  ...
  void initState() {
    super.initState();
    widgetList = getAnimationData(widget.animationType);
  }
  ...
  List<Widget> getAnimationData(AnimationType? animationType) {
    switch (animationType) {
      case AnimationType.contineous:
        return _buildContinuousAnimations();
      case AnimationType.steady:
        return _buildSteadyAnimations();
      case AnimationType.buttonTap:
        return _buildButtonTapAnimations();
      default:
        return [];
    }
  }
